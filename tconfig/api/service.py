...
from tconfig.api.resources import (
    ValueResource,
    ValueListResource,
    ParameterResource,
    ParameterListResource,
    ParameterValueListResource,
    ParameterExclusionResource,
    ParameterExclusionListResource,
...
def create_app(config_name="development") -> Flask:
    ...
    API.add_resource(
        ParameterExclusionListResource,
        "/parameters/<int:uid>/exclusions/",
        endpoint="parameter_exclude_list",
    )
    API.add_resource(
        ParameterExclusionResource,
        "/parameters/<int:puid>/exclusions/<int:euid>",
        endpoint="parameter_exclude",
    )
