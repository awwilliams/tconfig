...
from tconfig.api.schemas.parameter import ParameterSchema, NewParameterSchema, MoveParameterSchema
...
class ParameterListResource(Resource):
    ...
    def post(self):
        ...
        new_parameter = orm_utils.create_new_parameter(**value_info)
