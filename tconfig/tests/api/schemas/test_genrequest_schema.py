...
def test_serialize_gen_req(parm_set, configs):
    gen_req = GenerationRequest(parameter_set=parm_set, algorithm_name="recursive", coverage_degree=2,
...
@pytest.mark.usefixtures("orm")
def test_deserialize(parm_set, red, green, blue, seventies, eighties, twenties, dog, cat, bird, fast, medium, slow):
    data = {
        'algorithm_name': 'recursive',
        'coverage_degree': 2,
        'existing_configurations': [
...
@pytest.mark.usefixtures("orm")
def test_create_ipo_genrequest_degree_too_high(parm_set, red, green, blue, seventies, eighties, twenties, dog, cat,
                                               bird, fast, medium, slow):
    data = {
        'algorithm_name': 'ipo',
        'coverage_degree': 5,
        'existing_configurations': [],
...
def test_create_ipo_genrequest_bad_degree(
        parm_set, red, green, blue, seventies, eighties, twenties,
        dog, cat, bird, fast, medium, slow):
    data = {
        'algorithm_name': 'ipo',
        'coverage_degree': 0,
        'existing_configurations': [],
